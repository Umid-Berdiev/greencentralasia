      ...
      <div class="page-content">
        <div>
          <ol class="breadcrumb h6">
            ...
            <li><a href="{{URL(App::getLocale().'/video/')}}" title="@lang('blog.video')">@lang('blog.video')</a></li>
        ...
        <div class="col-md-6">
          ...
          <div class="embed-responsive embed-responsive-16by9">
            <a href="{{ URL(App::getLocale()."/video/".$value->group."/all") }}" class=""> <img
                src="{{URL(App::getLocale().'/downloads?type=video&id='.$value->group)}}" alt="" width="100%"
                height="250"></a>
          </div>
        </div>
        @endforeach
