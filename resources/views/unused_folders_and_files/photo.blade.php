    ...
    <div class="row">
      ...
      <div class="page-header row section-to-print">
        ...
        <div class="col-md-3 hidden-xs hidden-sm" style="padding-top: 11px;">
          ...
          <a class="rss-link pull-right" href="{{URL(\Illuminate\Support\Facadesapp()->getLocale().'/rss/photo')}}"><img
      ...
      <div class="row" id="print_all">
        ...
        <div class="col-md-4">
          ...
          <h4><a href="{{ URL(App::getLocale()." /photo/".$value->group."/all") }}"><b>{{$value->title}}</b></a>
          </h4>
