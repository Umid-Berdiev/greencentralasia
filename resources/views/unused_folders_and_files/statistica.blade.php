...
@section('content_div')
    <head>
        ...
        <style>h2{color:#fff;margin-bottom:40px;text-align:center;font-weight:100;}</style>
    </head>
                ...
                @section('nowosti')
                    <div class="page-content">
                        <div>
                            <ol class="breadcrumb h6">
                                ...
                                <li><a href="{{URL(App::getLocale().'/statistica')}}" title="@lang('blog.statistica')">@lang('blog.statistica')</a></li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row" id="print_all" >
                        ...
                        @foreach($table as $values)
                            <div class="col-md-6">
                                <a class="example-image-link " href="{{URL(App::getLocale().'/downloads?type=statistica&id='.$values->id)}}" data-lightbox="example-set" data-title="{{$values->description}}"><img height="200" width="100%" class="example-image" src="{{URL(App::getLocale().'/downloads?type=statistica&id='.$values->id)}}" alt="" /></a>
                            </div>
