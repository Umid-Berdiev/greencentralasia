    ...
    <div class="row">
      <div class="col-lg-6 col-sm-4 left_cal">
        ...
        <div class="bts_cal">
          ...
          <img src="{{ asset('project_gca/images/t.png') }}" alt="">
        </div>
...
<script type="text/javascript">
  $('#datepicker').datepicker({
    ...
    beforeShowDay: function (date) {
      ...
      let calender_date = date.getFullYear() + '-' + (date.getMonth() < 10 ? '0' + (date.getMonth() + 1) : (date.getMonth() + 1)) + '-' + (date.getDate() < 10 ? '0' + date.getDate() : date.getDate());
  ...
  $('#datepicker').on('changeDate', function () {
    ...
    window.location.href = "{{ url(app()->getLocale() . '/events')}}?date=" + $('#my_hidden_input').val()
  });
