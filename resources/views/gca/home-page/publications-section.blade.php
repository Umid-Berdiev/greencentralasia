<section class="news_section">
  <div class="container">
    <span class="template_span">@lang('blog.docs')</span>
    <h2 class="title">@lang('blog.new_docs')</h2>
    <div class="row">
      @foreach($docs as $item)
      <div class="col-sm-4">
        <div class="cart_item_news"
          style="background-image: url({{ url(app()->getLocale().'/downloads?type=docs&id='.$item->group) }}">
          ...
          <a href="{{ url(app()->getLocale().'/doc/1603263016/'.$item->group) }}">
            <h3>{{ $item->title  }}</h3>
          </a>
          <a href="{{ url(app()->getLocale().'/doc/1603263016/'.$item->group) }}" class="template_bord">
