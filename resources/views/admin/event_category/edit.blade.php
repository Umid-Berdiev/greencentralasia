...
<div class="card-body" style="background-color: white">
  <div class="col-md-12">
    ...
    <form class="form" role="form" enctype="multipart/form-data" method="post"
      action="{{ route('event-categories.update', $grp_id) }}">
      @csrf
      @method('put')
      ...
      <div class="card-body tab-content">
        ...
        <div class="tab-pane active" id="{{$language->id}}">
          <div class="form" role="form">
            ...
            <div class="form-group floating-label">
              <input type="text" required name="category_names[]" class="form-control" value="{{ $val->category_name }}"
                id="regular2">
        ...
        <div class="card-actionbar-row">
          <a href="{{ route('event-categories.index') }}" class="btn btn-secondary">Back</a>
