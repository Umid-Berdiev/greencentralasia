...
<div class="col-md-12" style="background-color: white;padding: 25px;">
  <div class="col-md-12">
    <div class="form-group">
      <a class="btn ink-reaction btn-floating-action btn-lg btn-primary" href="{{ route('videoalbum.create') }}">
        <i class="fa fa-plus"></i>
      </a>
      <br />
      <br />
      <form action="{{ route('videoalbum.index') }}" method="get">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <form style="display: inline;" action="{{ route('videoalbum.destroy', $page->group) }}" method="POST">
              @csrf
              @method('delete')
