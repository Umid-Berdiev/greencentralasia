...
<div class="col-md-12" style="background-color: white;padding: 25px;">
  <div class="col-md-12">
    <div class="form-group">
      <a class="btn ink-reaction btn-floating-action btn-lg btn-primary" href="{{ route('events.create') }}">
    ...
    <table class="table table-condensed no-margin">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <form style="display: inline;" action="{{ route('events.edit', $page->group) }}" method="get">
              <button>
                <i class="fa fa-edit"></i>
              </button>
            </form>
            <form style="display: inline;" action="{{ route('events.destroy', $page->group) }}" method="POST">
              @csrf
              @method('delete')
