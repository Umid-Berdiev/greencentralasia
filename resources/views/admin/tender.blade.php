    ...
    <div class="form-group">
      <p>
        <button type="button" class="btn ink-reaction btn-floating-action btn-lg btn-primary"
          onclick="window.location.href=\" {{ URL('/admin/tender/create') }}\"">
          <i class="fa fa-plus"></i>
        </button>
      </p>
      <form action="{{ URL('admin/tender') }}" method="get">
    ...
    <table class="table table-condensed no-margin">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <span><a href="{{URL('/admin/tender/edit?id='.$page->group)}}"><i class="fa fa-edit"></i></a></span>
            <span><a onclick="return confirm('Are you sure you want to delete this thing into the database?')"
                href="{{URL('/admin/tender/delete?id='.$page->group)}}"><i class="fa fa-remove"></i></a></span>
