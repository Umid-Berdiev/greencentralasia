...
<div class="card-body" style="background-color: white">
  <div class="col-md-12">
    ...
    <form class="form" role="form" enctype="multipart/form-data" method="post"
      action="{{ URL('/admin/sorovatter/edit') }}">
      @csrf
      ...
      <div class="card-body tab-content">
        ...
        <input type="hidden" name="savol_id" value="{{ $val->savol_id }}">
        ...
        <div class="tab-pane active" id="{{$language->id}}">
          <div class="form" role="form">
            ...
            <div class="form-group floating-label">
              <input type="text" name="javob[]" class="form-control" value="{{ $val->javob }}" id="regular2">
