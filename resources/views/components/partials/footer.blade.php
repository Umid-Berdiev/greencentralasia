    ...
    <div class="container">
      <div class="ftr_top_main">
        ...
        <div class="ft5">
          ...
          <br>
          <p class="text-capitalize mb-1">{{ __('blog.online_users') . ': ' . count($online_visitors) }}</p>
          <p class="text-capitalize mb-1">{{ __('blog.today_users') . ': ' . count($today_visitors) }}</p>
        </div>
      </div>
    </div>
  </div>
