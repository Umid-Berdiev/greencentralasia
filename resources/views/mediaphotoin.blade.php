            ...
            <div class="row">
                @section('nowosti')
                    <div class="page-content">
                        <div>
                            <ol class="breadcrumb h6">
                                ...
                                <li><a href="{{URL(App::getLocale().'/photo/')}}" title="@lang('blog.photo')">@lang('blog.photo')</a></li>
                            </ol>
                        </div>
                    </div>

                    <div class="page-header row section-to-printsection-to-print">
                        <div class="col-md-9">
                        ...
                        <div class="col-md-3 hidden-xs hidden-sm" style="padding-top: 11px;">
                            ...
                            <a class="rss-link pull-right" href="#"><img src="{{URL('/images/Feed-icon.svg.png')}}" alt="" width="20" height="20"> RSS</a>
                        </div>
                    </div>
                    <br>
                    ...
                    @foreach($table as $values)
                        <div class="col-md-3">
                            <a class="example-image-link " href="{{URL(App::getLocale().'/downloads?type=photoin&id='.$values->id)}}" data-lightbox="example-set" data-title="{{$values->description}}"><img height="150" width="100%" class="example-image" src="{{URL(App::getLocale().'/downloads?type=photoin&id='.$values->id)}}" alt="" /></a>
                        </div>
                        ...
                        <div class="list-group">
                            @foreach($newscat as $value)
                                @if($curcat->group == $value->group)
                                    <a href="{{ URL(App::getLocale().'/photo/'.$value->group) }}" class="list-group-item active">{{$value->title}}</a>
                                @else
                                    <a href="{{ URL(App::getLocale().'/photo/'.$value->group) }}" class="list-group-item">{{$value->title}}</a>
                                @endif
                            @endforeach
